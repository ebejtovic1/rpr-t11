...
public class ProzorController {
    ...
    public ProzorController(GeografijaDAO baza, DrzavaModel drzavaModel, GradModel gradModel, ResourceBundle bundle) {
    ...
    private void reloadScene() {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/prozor.fxml"), bundle);
    ...
    public void obrisiGradClick(ActionEvent actionEvent) {
        ...
        prikaziAlert(bundle.getString("uspjeh"), bundle.getString("uspjesnoIzbrisanGrad"));
    }
    ...
    public void obrisiDrzavuClick(ActionEvent actionEvent) {
        ...
        prikaziAlert(bundle.getString("uspjeh"), bundle.getString("uspjesnoIzbrisanaDrzava"));
    }
    ...
    private void doSave(File datoteka) {
        try {
            new GradoviReport().saveAs(datoteka.getAbsolutePath(), baza.getConn());
    ...
    public void saveAsClick(ActionEvent actionEvent) {
        ...
        Stage stage = (Stage) tabelaDrzava.getScene().getWindow();
